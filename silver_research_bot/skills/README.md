# silver_research_bot Skills

This directory contains built-in skills that extend silver_research_bot's capabilities.
...
When skills reference large local documentation or logs, prefer silver_research_bot's built-in
