...
try:
    ...
    raise ImportError(
        "Matrix dependencies not installed. Run: pip install silver_research_bot-ai[matrix]"
    ) from e
...
from silver_research_bot.config.paths import get_data_dir, get_media_dir
