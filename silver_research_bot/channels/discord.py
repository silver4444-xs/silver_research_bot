...
from silver_research_bot.utils.helpers import safe_filename, split_message
...
if DISCORD_AVAILABLE:
    ...
    class DiscordBotClient(discord.Client):
        ...
        async def send_outbound(self, msg: OutboundMessage) -> None:
            """Send a silver_research_bot outbound message using Discord transport rules."""
...
class DiscordChannel(BaseChannel):
    ...
    async def start(self) -> None:
        ...
        if not DISCORD_AVAILABLE:
            logger.error("discord.py not installed. Run: pip install silver_research_bot-ai[discord]")
            return
