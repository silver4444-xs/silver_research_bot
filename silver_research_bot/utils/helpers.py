...
_TOOL_RESULTS_DIR = ".silver_research_bot/tool-results"
...
def build_status_content(
    *,
    ...
    lines = [
        f"\U0001f408 silver_research_bot v{version}",
...
def sync_workspace_templates(workspace: Path, silent: bool = False) -> list[str]:
    ...
    try:
        tpl = pkg_files("silver_research_bot") / "templates"
    except Exception:
        return []
    if not tpl.is_dir():
        return []
